...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post cinemas_url, params: { cinema: { endereco: @cinema.endereco, nome: @cinema.nome } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { endereco: @cinema.endereco, nome: @cinema.nome } }
