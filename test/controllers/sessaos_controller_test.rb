...
class SessaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sessao" do
    assert_difference('Sessao.count') do
      post sessaos_url, params: { sessao: { cadeiras: @sessao.cadeiras, cinema_id: @sessao.cinema_id, filme_id: @sessao.filme_id, idade: @sessao.idade, inicio: @sessao.inicio, sala: @sessao.sala, tipo: @sessao.tipo, valor: @sessao.valor } }
    end
  ...
  test "should update sessao" do
    patch sessao_url(@sessao), params: { sessao: { cadeiras: @sessao.cadeiras, cinema_id: @sessao.cinema_id, filme_id: @sessao.filme_id, idade: @sessao.idade, inicio: @sessao.inicio, sala: @sessao.sala, tipo: @sessao.tipo, valor: @sessao.valor } }
